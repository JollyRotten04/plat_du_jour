...
import BookmarkUnfilled from '../../assets/unfilled-bookmark.svg';
import BookmarkFilled from '../../assets/filled-bookmark.svg';
...
export default function ViewContentPage({ currentPage }: { currentPage: string }){
    ...
    function renderStars(rating: number) {
        ...
        for (let i = 0; i < emptyStars; i++) {
            stars.push(
                <svg key={`empty-${i}`} className="w-4 h-4 lg:w-8 lg:h-8 fill-current text-gray-300" viewBox="0 0 20 20">
                    <path d="M10 15l-5.878 3.09 1.123-6.545L.49 6.91l6.572-.955L10 0l2.938 5.955 6.572.955-4.755 4.635 1.123 6.545z" />
                </svg>
            );
        }
